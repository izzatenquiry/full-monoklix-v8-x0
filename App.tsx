...
import { signOutUser, logActivity, getVeoAuthTokens, getSharedMasterApiKey, updateUserLastSeen, assignPersonalTokenAndIncrementUsage, saveUserPersonalAuthToken } from './services/userService';
...
const App: React.FC = () => {
  ...
  useEffect(() => {
   ...
   // Effect for user heartbeat (active status)
    ...
    useEffect(() => {
        const autoAssignPersonalToken = async () => {
        ...
        // This effect now runs whenever currentUser changes, enabling the self-healing mechanism.
        autoAssignPersonalToken();

    // The guard clauses inside autoAssignPersonalToken prevent unnecessary runs.
    // This hook is designed to trigger on any change to the user object.
